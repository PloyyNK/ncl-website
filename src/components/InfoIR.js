                    ...
                    <div className="modal">
                        ...
                        <div className="modal-content">
                            ...
                            <div className='office-info'>
                                <p className='mt-1'>Miss Rungarun Bongkodkanok</p>
                                ...
                                <p>Tak Sin Road, Bukkalo, Thonburi  Bangkok 10600</p>
                                <p className='font-bold text-sm'>Telephone : 02-459-4945</p>
                                <p className='font-bold text-sm'>Facsimile : 02-473-7374</p>
                                <p className='font-bold text-sm'>Email : ir@nclthailand.com</p>
                                <p className='font-bold text-sm'>Website : www.nclthailand.com</p>
                            </div>
                            <br></br>
                            <div className='ir-contact'>
                                <p>Mr.Tirawit Disphanurat</p>
                                <p className='text-sm'>Tel : 02-459-4888</p>
                                <p className='text-sm'>Email : tirawit.d@nclthailand.com</p>
                                <br></br>
                                <p>Miss Sirisara Watcharachatchawal</p>
